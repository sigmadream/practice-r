...
3등급 객실에 탑승한 승객이 가장 많음을 알 수 있습니다. 객실의 등급와 생존율이 연관있는지는 `Chapter5`에서 다루도록 하겠습니다.  ## 3.5 Fare
...
# 3-2. Relationship to target feature `Survived` & Feature selection 
...
## 8 Description of actual used features

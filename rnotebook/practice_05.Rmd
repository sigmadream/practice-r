...
# Data Visualize: ggplot2

```{r}
set.seed(42)
```

## Visualize distribution of a continuous variable: histogram & density plot
...
ggplot(data = df.unif, mapping = aes(x = x)) + 
  geom_histogram()
...
## Visualize distribution of a categorical variable: bar plot
...
## Visualize relation of 2 continuous variables: scatter plot
...
## Visualize relation of 2 categorical variables: bar plot & scatter plot
...
## Combine continuous and categorical variable: box plot & violin plot
...
## Create heatmaps maps word clouds

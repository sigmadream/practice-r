...
데이터프레임에 관련된 내용은 [이 곳](https://cran.r-project.org/doc/manuals/r-release/R-intro.html#Data-frames)을 참고하세요. 데이터프레임은 R에서 가장 많이 사용되는 자료구조이기 때문에, 해당 자료구조에 대해서 별도의 연습이 필요합니다. 관련하여 아래와 같은 교재를 참고하세요. [@musthaver]의 경우 3장, 4장을 참고하세요. [@forallr]의 경우 2장, 3장을 참고하세요.
